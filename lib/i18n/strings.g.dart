...
class _StringsAr implements Translations {
	...
	@override String get accept => 'تم القبول';
	@override String get unacceptable => 'تم الرفض';
	@override String get locationUpdateRequest => 'طلب تحديث الموقع';
	@override String get theAmountToBeReceived => 'المبلغ المطلوب إستلامه';
	@override String get additionalDetails => 'تفاصيل إضافية';
	@override String get tripInformation => 'معلومات الرحلة';
	@override String get from => 'من';
	@override String get to => 'إلى';
	@override String get serviceType => 'نوع الخدمة';
	@override String get dateCreated => 'تاريخ الإنشاء';
	@override String get thePeriodOfTimeToCarryTheShipment => 'فترة الوقت لحمل الشحنة';
	@override String get packageInformation => 'معلومات الطرد';
	@override String get packageType => 'نوع الطرد';
	...
	@override String get monetary => 'نقدي';
	@override String get ATM => 'بطاقة البنك';
	@override String get PaymentWasMadeVia => 'تم الدفع عن طريق';
	@override String get ServiceCost => 'تكلفة الخدمة';
	@override String get paid => 'مدفوع';
	@override String get cancel => 'رفض';
	@override String get InTheShippingStage => 'في مرحلة الشحن';
	@override String get clear => 'مسح';
	@override String get openCamera => 'إلتقط صورة';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'locationUpdateRequest': return 'location update request';
			case 'theAmountToBeReceived': return 'The amount to be received';
			case 'additionalDetails': return 'Additional details';
			case 'tripInformation': return 'Trip information';
			case 'from': return 'from';
			case 'to': return 'to';
			case 'serviceType': return 'service type';
			case 'dateCreated': return 'Date created';
			case 'thePeriodOfTimeToCarryTheShipment': return 'Cargo carrying time';
			case 'packageInformation': return 'Package information';
			case 'packageType': return 'Package type';
			...
			case 'paymentInformation': return 'payment information';
			case 'PaymentType': return 'Payment type';
			case 'monetary': return 'monetary';
			case 'ATM': return 'ATM';
			case 'PaymentWasMadeVia': return 'Payment was made via';
			case 'ServiceCost': return 'Service cost';
			case 'paid': return 'paid';
			case 'cancel': return 'Cancel';
			case 'InTheShippingStage': return 'In the shipping stage';
...
extension on _StringsAr {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'accept': return 'تم القبول';
			case 'unacceptable': return 'تم الرفض';
			case 'locationUpdateRequest': return 'طلب تحديث الموقع';
			case 'theAmountToBeReceived': return 'المبلغ المطلوب إستلامه';
			case 'additionalDetails': return 'تفاصيل إضافية';
			case 'tripInformation': return 'معلومات الرحلة';
			case 'from': return 'من';
			case 'to': return 'إلى';
			case 'serviceType': return 'نوع الخدمة';
			case 'dateCreated': return 'تاريخ الإنشاء';
			case 'thePeriodOfTimeToCarryTheShipment': return 'فترة الوقت لحمل الشحنة';
			case 'packageInformation': return 'معلومات الطرد';
			case 'packageType': return 'نوع الطرد';
			...
			case 'paymentInformation': return 'معلومات الدفع';
			case 'PaymentType': return 'نوع الدفع';
			case 'monetary': return 'نقدي';
			case 'ATM': return 'بطاقة البنك';
			case 'PaymentWasMadeVia': return 'تم الدفع عن طريق';
			case 'ServiceCost': return 'تكلفة الخدمة';
			case 'paid': return 'مدفوع';
			case 'cancel': return 'رفض';
			case 'InTheShippingStage': return 'في مرحلة الشحن';
			case 'clear': return 'مسح';
			case 'openCamera': return 'إلتقط صورة';
